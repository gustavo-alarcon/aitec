...
@Component({
  selector: 'app-shipping-master',
  templateUrl: './shipping-master.component.html',
  styleUrls: ['./shipping-master.component.scss']
})
export class ShippingMasterComponent implements OnInit {
